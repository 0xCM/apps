...
namespace Z0
{
    ...
    class ObjDumpParser
    {
        ...
        public Outcome Parse(WsContext context, in FileRef src, List<ObjDumpRow> dst)
        {
        ...
        public Outcome Parse(WsContext context, in FileRef src, out Index<ObjDumpRow> dst)
        {
            Reset(src);
