...
namespace Z0
{
    ...
    public class AsmSpecs
    {
        ...
        public static AsmInstruction and(r32 a, Imm32 b)
            => inst("and", AsmOpCode.Empty, a, b);

        [Op]
        public static AsmInstruction inst(in AsmMnemonic mnemonic, in AsmOpCode opcode, params AsmOperand[] ops)
        {
        ...
        [MethodImpl(Inline), Op]
        public static AsmInstruction inst(in AsmMnemonic mnemonic, in AsmOpCode opcode, in AsmOperands ops)
            => new AsmInstruction(mnemonic, opcode, ops);

        [MethodImpl(Inline), Op]
        public static ref AsmInstruction inst(in AsmMnemonic mnemonic, in AsmOpCode opcode, out AsmInstruction dst)
        {
        ...
        [MethodImpl(Inline), Op]
        public static ref AsmInstruction inst(in AsmMnemonic mnemonic, in AsmOpCode opcode, in AsmOperand op0, out AsmInstruction dst)
        {
        ...
        [MethodImpl(Inline), Op]
        public static ref AsmInstruction inst(in AsmMnemonic mnemonic, in AsmOpCode opcode, in AsmOperand op0, in AsmOperand op1, out AsmInstruction dst)
        {
            dst.Mnemonic = mnemonic;
            dst.OpCode = opcode;
            dst.Operands = AsmOperands.Empty;
        ...
        [MethodImpl(Inline), Op]
        public static ref AsmInstruction inst(in AsmMnemonic mnemonic, in AsmOpCode opcode, in AsmOperand op0, in AsmOperand op1, in AsmOperand op2, out AsmInstruction dst)
        {
            dst.Mnemonic = mnemonic;
            dst.OpCode = opcode;
            dst.Operands = AsmOperands.Empty;
        ...
        [MethodImpl(Inline), Op]
        public static ref AsmInstruction inst(in AsmMnemonic mnemonic, in AsmOpCode opcode, in AsmOperand op0, in AsmOperand op1, in AsmOperand op2, in AsmOperand op3, out AsmInstruction dst)
        {
            dst.Mnemonic = mnemonic;
            dst.OpCode = opcode;
            dst.Operands = AsmOperands.Empty;
