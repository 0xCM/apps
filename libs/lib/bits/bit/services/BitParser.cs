...
namespace Z0
{
    ...
    public readonly struct BitParser
    {
        ...
        // public static bool parse<N>(string src, N n, out bits<byte> dst)
        //     where N : unmanaged, ITypeNat
        // {
        //     var result = parse(src, (byte)n.NatValue, out byte value);
        //     dst = value;
        //     return result;
        // }

        // public static bool parse<N>(string src, N n, out bits<ushort> dst)
        //     where N : unmanaged, ITypeNat
        // {
        //     var result = parse(src, (byte)n.NatValue, out ushort value);
        //     dst = value;
        //     return result;
        // }

        // public static bool parse<N>(string src, N n, out bits<uint> dst)
        //     where N : unmanaged, ITypeNat
        // {
        //     var result = parse(src, (byte)n.NatValue, out uint value);
        //     dst = value;
        //     return result;
        // }

        // public static bool parse<N>(string src, N n, out bits<ulong> dst)
        //     where N : unmanaged, ITypeNat
        // {
        //     var result = parse(src, (byte)n.NatValue, out ulong value);
        //     dst = value;
        //     return result;
        // }
