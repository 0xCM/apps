...
namespace Z0
{
    ...
    partial struct AsciBlocks
    {
        ...
        public static string format(in AsciBlock128 src)
        {
            ...
            var v2 = cpu.vload(w256, seek(storage, 32*1));
            var v3 = cpu.vload(w256, seek(storage, 32*2));
            var v4 = cpu.vload(w256, seek(storage, 32*3));
            ...
            var chars = recover<char>(bytes(new V512x4(x0,x1,x2,x3,x4,x5,x6,x7)));
