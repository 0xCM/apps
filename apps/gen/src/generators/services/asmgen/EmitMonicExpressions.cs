...
namespace Z0.Asm
{
    ...
    partial class AsmModelGen
    {
        ...
        void EmitMonicExpressions(ReadOnlySpan<AsmMnemonic> monics, FS.FilePath dst)
        {
        ...
        public static void EmitMonicExpressions(ReadOnlySpan<AsmMnemonic> monics, uint margin, ITextBuffer buffer)
        {
