        ...
        public static FieldValue update(string src, FieldKind kind, ref RuleState state)
        {
            ...
            switch(kind)
            {
                ...
                case K.BASE0:
                    ...
                    fieldval = value(kind, fc, state.BASE0);
                break;

                case K.BASE1:
                    result = P.xedreg(src, out state.BASE1);
                    fieldval = value(kind, fc, state.BASE1);
                break;

                case K.BCAST:
                    result = DataParser.eparse(src, out state.BCAST);
                    fieldval = value(kind, fc, state.BCAST);
                break;
                ...
                case K.BRDISP_WIDTH:
                    ...
                    fieldval = value(kind, fc, state.BRDISP_WIDTH);
                break;
                ...
                case K.CHIP:
                    ...
                    fieldval = value(kind, fc, state.CHIP);
                break;
                ...
                case K.DEFAULT_SEG:
                    ...
                    fieldval = value(kind, fc, state.DEFAULT_SEG);
                break;
                ...
                case K.DISP:
                    ...
                    fieldval = value(kind, fc, state.DISP);
                break;

                case K.DISP_WIDTH:
                    result = DataParser.parse(src, out state.DISP_WIDTH);
                    fieldval = value(kind, fc, state.DISP_WIDTH);
                break;
                ...
                case K.EASZ:
                    ...
                    fieldval = value(kind, fc, state.EASZ);
                break;

                case K.ELEMENT_SIZE:
                    result = DataParser.parse(src, out state.ELEMENT_SIZE);
                    fieldval = value(kind, fc, state.ELEMENT_SIZE);
                break;
                ...
                case K.EOSZ:
                    ...
                    fieldval = value(kind, fc, state.EOSZ);
                break;

                case K.ESRC:
                    result = DataParser.parse(src, out state.ESRC);
                    fieldval = value(kind, fc, state.ESRC);
                break;

                case K.FIRST_F2F3:
                    result = DataParser.parse(src, out state.FIRST_F2F3);
                    fieldval = value(kind, fc, state.FIRST_F2F3);
                break;
                ...
                case K.HINT:
                    ...
                    fieldval = value(kind, fc, state.HINT);
                break;

                case K.ICLASS:
                    result = DataParser.eparse(src, out state.ICLASS);
                    fieldval = value(kind, fc, state.ICLASS);
                break;
                ...
                case K.ILD_SEG:
                    ...
                    fieldval = value(kind, fc, state.ILD_SEG);
                break;
                ...
                case K.IMM1_BYTES:
                    ...
                    fieldval = value(kind, fc, state.IMM1_BYTES);
                break;

                case K.IMM_WIDTH:
                    result = DataParser.parse(src, out state.IMM_WIDTH);
                    fieldval = value(kind, fc, state.IMM_WIDTH);
                break;

                case K.INDEX:
                    result = P.xedreg(src, out state.INDEX);
                    fieldval = value(kind, fc, state.INDEX);
                break;

                case K.LAST_F2F3:
                    result = DataParser.parse(src, out state.LAST_F2F3);
                    fieldval = value(kind, fc, state.LAST_F2F3);
                break;

                case K.LLRC:
                    result = DataParser.parse(src, out state.LLRC);
                    fieldval = value(kind, fc, state.LLRC);
                break;
                ...
                case K.MAP:
                    ...
                    fieldval = value(kind, fc, state.MAP);
                break;

                case K.MASK:
                    result = DataParser.parse(src, out state.MASK);
                    fieldval = value(kind, fc, state.MASK);
                break;

                case K.MAX_BYTES:
                    result = DataParser.parse(src, out state.MAX_BYTES);
                    fieldval = value(kind, fc, state.MAX_BYTES);
                break;

                case K.MEM_WIDTH:
                    result = DataParser.parse(src, out state.MEM_WIDTH);
                    fieldval = value(kind, fc, state.MEM_WIDTH);
                break;
                ...
                case K.NPREFIXES:
                    ...
                    fieldval = value(kind, fc, state.NPREFIXES);
                break;

                case K.NREXES:
                    result = DataParser.parse(src, out state.NREXES);
                    fieldval = value(kind, fc, state.NREXES);
                break;

                case K.NSEG_PREFIXES:
                    result = DataParser.parse(src, out state.NSEG_PREFIXES);
                    fieldval = value(kind, fc, state.NSEG_PREFIXES);
                break;
                ...
                case K.OUTREG:
                    ...
                    fieldval = value(kind, fc, state.OUTREG);
                break;

                case K.REG0:
                    result = P.xedreg(src, out state.REG0);
                    fieldval = value(kind, fc, state.REG0);
                break;

                case K.REG1:
                    result = P.xedreg(src, out state.REG1);
                    fieldval = value(kind, fc, state.REG1);
                break;

                case K.REG2:
                    result = P.xedreg(src, out state.REG2);
                    fieldval = value(kind, fc, state.REG2);
                break;

                case K.REG3:
                    result = P.xedreg(src, out state.REG3);
                    fieldval = value(kind, fc, state.REG3);
                break;

                case K.REG4:
                    result = P.xedreg(src, out state.REG4);
                    fieldval = value(kind, fc, state.REG4);
                break;

                case K.REG5:
                    result = P.xedreg(src, out state.REG5);
                    fieldval = value(kind, fc, state.REG5);
                break;

                case K.REG6:
                    result = P.xedreg(src, out state.REG6);
                    fieldval = value(kind, fc, state.REG6);
                break;

                case K.REG7:
                    result = P.xedreg(src, out state.REG7);
                    fieldval = value(kind, fc, state.REG7);
                break;

                case K.REG8:
                    result = P.xedreg(src, out state.REG8);
                    fieldval = value(kind, fc, state.REG8);
                break;

                case K.REG9:
                    result = P.xedreg(src, out state.REG9);
                    fieldval = value(kind, fc, state.REG9);
                break;

                case K.REP:
                    result = DataParser.parse(src, out state.REP);
                    fieldval = value(kind, fc, state.REP);
                break;
                ...
                case K.RM:
                    ...
                    fieldval = value(kind, fc, state.RM);
                break;

                case K.ROUNDC:
                    result = DataParser.parse(src, out state.ROUNDC);
                    fieldval = value(kind, fc, state.ROUNDC);
                break;
                ...
                case K.UIMM0:
                    ...
                    fieldval = value(kind, fc, state.UIMM0);
                break;

                case K.UIMM1:
                    result = imm8.parse(src, out state.UIMM1);
                    fieldval = value(kind, fc, state.UIMM1);
                break;
                ...
                case K.VEXDEST210:
                    ...
                    fieldval = value(kind, fc, state.VEXDEST210);
                break;
                ...
                case K.VEXVALID:
                    ...
                    fieldval = value(kind, fc, state.VEXVALID);
                break;
                ...
                case K.VEX_PREFIX:
                    ...
                    fieldval = value(kind, fc, state.VEX_PREFIX);
                break;

                case K.VL:
                    result = DataParser.parse(src, out state.VL);
                    fieldval = value(kind, fc, state.VL);
                break;
