...
namespace Z0
{
    ...
    public struct XedEncRequest
    {

    }

    public struct XedEncRequests
    {
        ...
        public const string Req1B = "";

        public const string Req1C = "";

        public const string Req1D = "";

        public const string Req1E = "";

        public const string Req1F = "";
