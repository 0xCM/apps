...
namespace Z0
{
    ...
    partial class ProjectCmdProvider
    {
        ...
        {
            var result = ProjectData.BuildLlc(Project(), SubtargetKind.Avx512, true);
            if(result)
            {
