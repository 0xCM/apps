...
namespace Z0
{
    ...
    public class BitPattern
    {
        ...
        /// </summary>
        public readonly BitPatternSpec Spec;

        internal BitPattern(in BitPatternDef def, byte width, Type datatype, NativeSize minsize, Index<BfSegModel> segs, string descriptor)
        {
            Def = def;
            DataWidth = width;
            DataType = datatype;
